...
def create_parser() -> argparse.ArgumentParser:
    ...
    info_parser = subparsers.add_parser(
        'info', 
        help='Get information about a Zarr store'
    )
    ...
    info_parser.add_argument(
        '--storage-options', 
        help='Storage options as JSON or key=value,key=value'
    )
    ...
    read_parser = subparsers.add_parser(
        'read',
        help='Read a Zarr array and save to Parquet'
    )
    ...
    read_parser.add_argument(
        '--select-dims',
        help='Dimension selection as Python dict string'
    )
    read_parser.add_argument(
        '--no-streaming',
        dest='streaming',
    ...
    benchmark_parser = subparsers.add_parser(
        'benchmark',
        help='Run a simple benchmark test'
    )
